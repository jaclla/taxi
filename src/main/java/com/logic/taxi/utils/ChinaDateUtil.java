...
public class ChinaDateUtil {
    public final static LocalDate baseDate = LocalDate.parse("1900-01-31");
     ...
     * @return
     */
    public static Integer animalsYear(Integer year) {
        if (year < baseDate.getYear()) {
            return null;
        }
        return (year - 4) % 12;
    }
     ...
     * @return
     */
    public static Integer animalsYear(LocalDate date) {
        if (date.isBefore(ChinaDateUtil.baseDate)) {
            return null;
        }
        return (getChinaDateYear(date) - 4) % 12;
    }
     ...
     * @return
     */
    final public String animalsYearString(Integer year) {
     ...
     * @return
     */
    final public String cyclical(Integer year) {
     ...
     * @return
     */
    public static LocalDate getChinaDate(LocalDate date) {
        int leapMonth;
        //求出和1900年1月31日相差的天数
        int offset = (int) (date.toEpochDay() - baseDate.toEpochDay());
        //用offset减去每农历年的天数
        // 计算当天是农历第几天
        //i最终结果是农历的年份
        //offset是当年的第几天
     ...
     * @return
     */
    public static Integer getChinaDateYear(LocalDate date) {
        int leapMonth;
        //求出和1900年1月31日相差的天数
        int offset = (int) (date.toEpochDay() - baseDate.toEpochDay());
        //用offset减去每农历年的天数
