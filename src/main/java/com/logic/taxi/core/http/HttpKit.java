 ...
 */
package com.logic.taxi.core.http;
...
public class HttpKit {
    ...
    public static String getIp() {
        return HttpKit.getXSSWrapperRequest().getRemoteHost();
    }
    ...
    public static Map<String, String> getRequestParameters() {
        ...
        HttpServletRequest request = HttpKit.getXSSWrapperRequest();
     ...
     * @return request
     */
    public static HttpServletRequest getXSSWrapperRequest() {
